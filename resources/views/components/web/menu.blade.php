 ...
 <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
   ...
   <div class="app-brand demo ">
     <a href="{{ route('dashboard.index') }}" class="app-brand-link">
       ...
       <span class="app-brand-text demo menu-text fw-bold ms-2">Notpers</span>
     </a>
       ...
       @can($menu->permission_name)
         ...
         <li class="menu-item {{ $isActive ? 'active open' : '' }}">
           ...
           <a href="javascript:void(0);" class="menu-link menu-toggle">
             ...
             <div class="text-truncate" data-i18n="Dashboards">{{ $menu->name }}</div>
           </a>
               ...
               @can($item->permission_name)
                 <li class="menu-item {{ request()->routeIs($item->route) ? 'active' : '' }}">
                   <a href="{{ route($item->route) }}" class="menu-link">
                     <div class="text-truncate" data-i18n="Analytics"> {{ $item->name }}</div>
                   </a>
                 </li>
               @endcan
             @endforeach
